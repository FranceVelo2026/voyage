...
{n:13,date:'Dimanche 13 septembre 2026',title:'Dijon → Beaune',spirit:'Raccourcir la journée pour prendre le temps de découvrir les villages et les vignobles de la Route des Grands Crus.',facts:[['Distance','41,8 km'],['Dénivelé positif','Environ 360 m'],['Arrivée','Beaune'],['Hébergement','Airbnb à réserver — Beaune']],stops:[
...
['Château du Clos de Vougeot — vers le km 18','Le parcours passe tout près de ce monument emblématique au milieu des vignes.<br><strong>Pourquoi s’arrêter :</strong> même sans visite intérieure, le château et son environnement justifient une pause au cœur du vignoble.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Chateau+du+Clos+de+Vougeot']]],
['Nuits-Saint-Georges — vers le km 23','Principale ville de services avant Beaune, avec commerces, boulangeries, pharmacie et possibilités de ravitaillement.<br><strong>Pourquoi s’arrêter :</strong> c’est une halte pratique pour les provisions et une autre étape importante de la Route des Grands Crus.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Nuits-Saint-Georges+centre'],['🥐 Boulangeries','https://www.google.com/maps/search/?api=1&query=boulangerie+Nuits-Saint-Georges']]],
['Arrivée — Beaune','Terminer l’étape à Beaune après environ 41,8 km. Cette arrivée plus tôt laisse davantage de temps pour visiter la ville et profiter des vignobles parcourus pendant la journée.'],
['🏡 Hébergement','L’Airbnb n’est pas encore réservé. Privilégier un logement près du centre ou du parcours, avec un endroit sécuritaire pour les deux vélos.'],
['🛒 Repas et provisions','Le centre de Beaune offre des boulangeries, traiteurs, épiceries et commerces permettant de préparer un repas simple ou d’acheter les provisions du lendemain.']
],links:[
['GPX - Dijon @ Beaune','https://ridewithgps.com/routes/56233575'],
['🏡 Demander à Alice de trouver un Airbnb','https://chatgpt.com/'],
['🥡 Repas à emporter — Beaune','https://www.google.com/maps/search/?api=1&query=restaurant+a+emporter+Beaune'],
['🛒 Épiceries et marchés — Beaune','https://www.google.com/maps/search/?api=1&query=epicerie+marche+Beaune']
]},
