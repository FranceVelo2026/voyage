...
...Array.from({length:9},(_,i)=>({n:i+19,date:`${i+19} septembre 2026`,title:i===8?'Arrivée à Sète':'Étape vélo à préciser',spirit:i===8?'Atteindre la Méditerranée et savourer le chemin parcouru.':'Cette étape sera complétée lorsque le découpage définitif sera confirmé.',pending:i!==8,facts:[['Statut',i===8?'Arrivée prévue':'À compléter'],['Parcours','Voir RideWithGPS']],stops:[['Préparation','Cette journée sera détaillée lorsque le découpage définitif des étapes sera confirmé.']]}))
];
