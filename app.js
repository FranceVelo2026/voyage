...
['Rhônexpress → Lyon Part-Dieu','Prendre le Rhônexpress jusqu’à Lyon Part-Dieu. Le trajet dure environ 30 minutes. Les départs sont fréquents en journée.',[['🎟️ Billets Rhônexpress','https://www.rhonexpress.fr/'],['📍 Gare Lyon Part-Dieu','https://www.google.com/maps/search/?api=1&query=Gare+Lyon+Part-Dieu']]],
['Gare Part-Dieu → Airbnb','Rejoindre l’Airbnb au 14, rue Saint-Victorien, 69003 Lyon, avec les vélos et les bagages.',[['🏡 Ouvrir l’Airbnb dans Google Maps','https://www.google.com/maps/search/?api=1&query=14+Rue+Saint-Victorien+69003+Lyon']]],
...
],links:[['🏡 Airbnb — 14 rue Saint-Victorien','https://www.google.com/maps/search/?api=1&query=14+Rue+Saint-Victorien+69003+Lyon'],['🚆 Gare Lyon Part-Dieu','https://www.google.com/maps/search/?api=1&query=Gare+Lyon+Part-Dieu'],['🎟️ Rhônexpress','https://www.rhonexpress.fr/']]},
...
['Vieux-Lyon','Quartier Renaissance aux ruelles pavées, cours intérieures et traboules. Une belle introduction à l’histoire et à l’ambiance de Lyon.<br><strong>⏱️ Durée suggérée :</strong> 1 h 30 à 2 h.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Vieux-Lyon,+Lyon'],['📖 En savoir plus','https://www.visiterlyon.com/decouvrir/les-quartiers-de-lyon/le-vieux-lyon']]],
['Fourvière et son belvédère','Le belvédère offre l’un des meilleurs panoramas sur la ville. La visite intérieure de la basilique demeure facultative selon votre envie.<br><strong>⏱️ Durée suggérée :</strong> 45 à 60 min.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Basilique+Notre-Dame+de+Fourvi%C3%A8re,+Lyon'],['📖 En savoir plus','https://www.fourviere.org/']]],
['Presqu’île et places centrales','Promenade urbaine entre la place Bellecour, les rues commerçantes, les façades historiques et les quais du Rhône et de la Saône.<br><strong>⏱️ Durée suggérée :</strong> 1 h 30 à 2 h.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Place+Bellecour,+Lyon'],['📖 En savoir plus','https://www.visiterlyon.com/decouvrir/les-quartiers-de-lyon/la-presqu-ile']]],
...
['Barrage Vauban','Ancien ouvrage défensif construit à la fin du XVIIe siècle. Sa terrasse panoramique offre une vue remarquable sur les Ponts Couverts, la Petite France et la cathédrale.<br><strong>⏱️ Durée suggérée :</strong> 30 à 45 min.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Barrage+Vauban,+Strasbourg'],['📖 En savoir plus','https://www.visitstrasbourg.fr/decouvrir-strasbourg/les-incontournables/la-petite-france/']]],
['Quartier européen','Secteur moderne regroupant le Parlement européen, le Conseil de l’Europe et la Cour européenne des droits de l’homme. L’option à vélo permet d’y aller facilement depuis le centre.<br><strong>⏱️ Durée suggérée :</strong> 1 h à 1 h 30.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Parlement+europ%C3%A9en,+Strasbourg'],['📖 En savoir plus','https://www.visitstrasbourg.fr/decouvrir-strasbourg/les-incontournables/le-quartier-europeen/']]],
...
{n:5,date:'Samedi 5 septembre 2026',title:'Strasbourg → Obernai',spirit:'Première vraie journée à vélo : prendre le rythme et profiter des villages sans se presser.',facts:[['Distance','40,1 km'],['Dénivelé positif','Environ 370 m'],['Pause déjeuner possible','km 18 et km 30'],['Arrivée','Centre d’Obernai']],stops:[['Départ — Airbnb de Strasbourg','Départ directement du 17, rue des Orfèvres.'],['Route des Vins d’Alsace','Rouler tranquillement vers le sud.'],['Rosheim','Pause recommandée dans le centre ancien. Prévoir environ 30 à 60 minutes.'],['Boersch','Petit détour facultatif.'],['Arrivée — centre d’Obernai','Le GPX se termine près de la Place du Marché.'],
...
['🥐 Pause déjeuner — option 1','Vers le km 18, dans le secteur de Molsheim. Vérifiez les heures d’ouverture le jour même avant de quitter Strasbourg.'],
['🥐 Pause déjeuner — option 2','Vers le km 30, dans le secteur de Rosheim. Cette option convient si vous préférez rouler plus longtemps avant de manger.'],
['🍽️ Repas à proximité','À l’arrivée, recherchez les restaurants, traiteurs et pizzerias qui offrent des plats à emporter près du centre d’Obernai.'],
['🛒 Épicerie / marché','Le centre d’Obernai offre plusieurs commerces pratiques pour acheter un repas simple ou des provisions pour le lendemain.'],
['⭐ À ne pas manquer','Rosheim, Boersch et le centre historique d’Obernai constituent les principaux attraits de l’étape.'],
['💡 Conseil d’Alice','Gardez un peu d’énergie pour l’arrivée à Obernai : la Place du Marché et les petites rues du centre se découvrent très bien à pied après avoir rangé les vélos.']],links:[['GPX - Strasbourg @ Obernai','https://ridewithgps.com/routes/56119326?privacy_code=gR1X6B7fXNiKgXeQr0U5Vr9FZRj7y1XW'],['🏡 Demander à Alice de trouver un Airbnb','https://chatgpt.com/'],
['🥐 Pâtisseries vers le km 18 — Molsheim','https://www.google.com/maps/search/?api=1&query=p%C3%A2tisserie+boulangerie+Molsheim'],
['🥐 Pâtisseries vers le km 30 — Rosheim','https://www.google.com/maps/search/?api=1&query=p%C3%A2tisserie+boulangerie+Rosheim'],
['🥡 Repas à emporter près du centre d’Obernai','https://www.google.com/maps/search/?api=1&query=restaurant+%C3%A0+emporter+centre+Obernai'],
...
{n:6,date:'Dimanche 6 septembre 2026',title:'Obernai → Colmar',spirit:'Suivre la Route des Vins à votre rythme en profitant des villages viticoles et des paysages d’Alsace.',facts:[['Distance','59 km'],['Dénivelé positif','418 m'],['Pause déjeuner possible','km 25 et km 35'],['Arrivée','Centre de Colmar']],stops:[['Départ — centre d’Obernai','Le parcours commence au centre d’Obernai et rejoint directement la Route des Vins vers le sud.'],['🥐 Pause déjeuner — option 1','Vers le km 25, à Dambach-la-Ville. Une bonne première halte après environ 1 h 30 à 2 h de vélo. Vérifiez les heures d’ouverture le jour même.'],['🥐 Pause déjeuner — option 2','Vers le km 35, dans le secteur de Sélestat. Cette option convient si vous préférez rouler un peu plus longtemps avant de vous arrêter.'],['🍽️ Repas à proximité','À Colmar, recherchez les restaurants, traiteurs et pizzerias offrant des plats à emporter près du centre historique.'],['🛒 Épicerie / marché','Le Marché couvert et les commerces du centre sont pratiques pour acheter un repas simple ou les provisions du lendemain.'],['⭐ À ne pas manquer','Barr, Mittelbergheim, Dambach-la-Ville, les paysages de la Route des Vins et le centre historique de Colmar.']],links:[['GPX - Obernai @ Colmar','https://ridewithgps.com/routes/56138400?privacy_code=AUMeEmXbCl6vSuChQF7XXFwFv2AmxMVH'],['🏡 Demander à Alice de trouver un Airbnb','https://chatgpt.com/'],['🥐 Pâtisseries — Dambach-la-Ville','https://www.google.com/maps/search/?api=1&query=p%C3%A2tisserie+boulangerie+Dambach-la-Ville'],['🥐 Pâtisseries — Sélestat','https://www.google.com/maps/search/?api=1&query=p%C3%A2tisserie+boulangerie+S%C3%A9lestat'],['🥡 Repas à emporter — Colmar centre','https://www.google.com/maps/search/?api=1&query=restaurant+%C3%A0+emporter+centre+Colmar'],['🛒 Marché couvert de Colmar','https://www.google.com/maps/search/?api=1&query=March%C3%A9+couvert+de+Colmar'],['📍 Centre de Colmar','https://www.google.com/maps/search/?api=1&query=centre+historique+Colmar']]},
{n:7,date:'Lundi 7 septembre 2026',title:'Colmar → Aspach-le-Bas',spirit:'Quitter la Route des vins par une étape plus directe, puis longer le secteur du canal avant une arrivée calme au sud de Mulhouse.',facts:[['Distance','69.4 km'],['Dénivelé positif','Environ 477 m'],['Pause déjeuner possible','Rouffach et Cernay'],['Arrivée','Aspach-le-Bas']],stops:[
...
['⭐ Rouffach','Charmante cité viticole aux rues anciennes et aux maisons alsaciennes traditionnelles.<br><strong>⏱️ Durée suggérée :</strong> 20 min.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=centre+historique+Rouffach'],['📖 En savoir plus','https://www.tourisme-eguisheim-rouffach.com/FR/Rouffach-f253001819.html']]],
...
['🥡 Repas à emporter — Aspach-le-Bas','https://www.google.com/maps/search/?api=1&query=restaurant+%C3%A0+emporter+Aspach-le-Bas'],
...
['🥡 Repas à emporter — Besançon','https://www.google.com/maps/search/?api=1&query=restaurant+%C3%A0+emporter+Besan%C3%A7on'],
...
{n:10,date:'Jeudi 10 septembre 2026',title:'Besançon → Dole',spirit:'Suivre la vallée du Doubs jusqu’à Dole en gardant un rythme confortable avant l’arrivée à Dijon le lendemain.',facts:[['Distance','58,1 km'],['Dénivelé positif','413 m'],['Pause déjeuner possible','Saint-Vit ou Ranchot'],['Hébergement','Airbnb à réserver']],stops:[
...
],links:[['🚶 Ouvrir l’itinéraire complet à pied dans Google Maps','https://www.google.com/maps/dir/?api=1&origin=86%20Rue%20Monge%2C%2021000%20Dijon%2C%20France&destination=Mus%C3%A9e%20des%20Beaux-Arts%20de%20Dijon%2C%20Place%20des%20Ducs%20de%20Bourgogne%2C%2021000%20Dijon%2C%20France&travelmode=walking&waypoints=Halles%20Centrales%20de%20Dijon%2C%20Rue%20Bannelier%2C%2021000%20Dijon%2C%20France%7CParcours%20de%20la%20Chouette%2C%20Rue%20de%20la%20Chouette%2C%2021000%20Dijon%2C%20France%7CPalais%20des%20Ducs%20et%20des%20%C3%89tats%20de%20Bourgogne%2C%20Dijon%2C%20France%7CTour%20Philippe%20le%20Bon%2C%20Dijon%2C%20France']]},
{n:13,date:'Dimanche 13 septembre 2026',title:'Boucle dans les vignobles',spirit:'Profiter d’une journée légère, sans bagages, pour rouler dans les vignobles de la Côte de Nuits et choisir librement une ou deux visites de domaines.',facts:[['Distance','25,3 km'],['Dénivelé positif','231 m'],['Type','Boucle à vélo sans bagages'],['Visites','Un ou deux domaines, à décider sur place']],stops:[
...
['Domaine René Leclerc — Gevrey-Chambertin','Première visite possible de la journée. Ce domaine familial produit notamment plusieurs Gevrey-Chambertin, premiers crus et grands crus. La visite et la dégustation dépendent des disponibilités du domaine.<br><strong>Décision sur place :</strong> faire cette visite, poursuivre vers Morey-Saint-Denis, ou conserver l’énergie pour le second domaine.',[['🌐 Site du domaine','https://domainereneleclerc.com/'],['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Domaine+Rene+Leclerc+Gevrey-Chambertin']]],
['Domaine des Beaumont — Morey-Saint-Denis','Deuxième visite possible. Cette petite exploitation familiale travaille des parcelles à Morey-Saint-Denis, Gevrey-Chambertin et Chambolle-Musigny. La visite permettrait de découvrir un domaine plus intime et une gamme représentative de plusieurs villages de la Côte de Nuits.<br><strong>Décision sur place :</strong> visiter ce domaine seul ou l’ajouter au Domaine René Leclerc, selon les disponibilités et votre envie.',[['ℹ️ Information sur le domaine','https://www.gevreynuitstourisme.com/ddata/domaine-des-beaumont/'],['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Domaine+des+Beaumont+Morey-Saint-Denis']]],
...
{n:14,date:'Lundi 14 septembre 2026',title:'Marsannay-la-Côte → Chagny',spirit:'Reprendre la route à travers les grands vignobles de Bourgogne et réserver l’arrêt principal de la journée à Meursault.',facts:[['Distance','70,3 km'],['Dénivelé positif','438 m'],['Arrêt principal','Meursault'],['Hébergement','À confirmer — Chagny']],stops:[
...
['Nuits-Saint-Georges — vers le km 19','Premier véritable arrêt de la journée : boulangerie ou pâtisserie, remplissage des bouteilles et ravitaillement au besoin.',[['🥐 Pâtisserie Olivier Bourau — Google Maps','https://www.google.com/maps/search/?api=1&query=Patisserie+Olivier+Bourau+28+Grande+Rue+Nuits-Saint-Georges'],['🥐 Autres boulangeries à proximité','https://www.google.com/maps/search/?api=1&query=boulangerie+patisserie+Nuits-Saint-Georges']]],
...
{n:15,date:'Mardi 15 septembre 2026',title:'Chagny → Tournus',spirit:'Profiter d’une étape plus douce le long de la Saône, avec une vraie pause gourmande à Chalon-sur-Saône.',facts:[['Distance','Environ 53 km'],['Dénivelé positif','173 m'],['Pause pâtisserie','Chalon-sur-Saône'],['Hébergement','À confirmer — Tournus']],stops:[
...
['Chalon-sur-Saône — vers le km 21','Première grande halte après environ une à deux heures de vélo. Profiter du centre pour une pâtisserie, remplir les bouteilles et faire quelques achats au besoin.',[['🥐 Allex — pâtissier, chocolatier et glacier','https://www.google.com/maps/search/?api=1&query=Allex+Patissier+11+Place+de+l%27Hotel+de+Ville+Chalon-sur-Saone'],['🥐 La Tartelière — Google Maps','https://www.google.com/maps/search/?api=1&query=La+Tarteliere+4+Rue+Saint+Vincent+Chalon-sur-Saone']]],
...
['🏡 Hébergements — Belleville-en-Beaujolais','https://www.google.com/maps/search/?api=1&query=hebergement+Belleville-en-Beaujolais']
]},
{n:17,date:'Jeudi 17 septembre 2026',title:'Belleville-en-Beaujolais → Givors',spirit:'Traverser l’agglomération lyonnaise sans s’y arrêter et contourner entièrement le tronçon déconseillé de la ViaRhôna.',facts:[['Distance','76,0 km'],['Dénivelé positif','438 m'],['Pause pâtisserie','Neuville-sur-Saône — vers le km 35'],['Hébergement','À confirmer — Givors']],stops:[
...
['Neuville-sur-Saône — vers le km 35','Faire ici la principale pause pâtisserie de la journée, après environ une heure et demie à deux heures de vélo. Profiter de l’arrêt pour remplir les bouteilles et acheter un sandwich ou des provisions pour la suite.',[['🥐 Pâtisseries et boulangeries — Neuville-sur-Saône','https://www.google.com/maps/search/?api=1&query=patisserie+boulangerie+Neuville-sur-Saone'],['📍 Centre de Neuville-sur-Saône','https://www.google.com/maps/search/?api=1&query=centre+Neuville-sur-Saone']]],
['Traversée de Lyon — sans arrêt touristique','Suivre le tracé à travers l’agglomération lyonnaise sans programmer de visite, puisque vous aurez déjà séjourné à Lyon au début du voyage et y retournerez pour les deux dernières nuits. Rester particulièrement attentifs aux intersections, aux piétons et à la circulation urbaine.'],
...
['🏡 Hébergements — Givors','https://www.google.com/maps/search/?api=1&query=hebergement+Givors']
]},
{n:18,date:'Vendredi 18 septembre 2026',title:'Givors → Tain-l’Hermitage',spirit:'Quitter l’agglomération lyonnaise, retrouver progressivement les paysages du Rhône et terminer la journée au pied des coteaux de l’Hermitage.',facts:[['Distance','77,6 km'],['Dénivelé positif','366 m'],['Parcours','RideWithGPS 56790082'],['Arrivée','Tain-l’Hermitage']],stops:[
...
['1. Marché de Tain-l’Hermitage','Commencer la matinée au marché du samedi, place du Taurobole. Acheter de quoi préparer le souper puis revenir déposer les provisions à l’Airbnb avant de repartir.<br><strong>Horaire actuel :</strong> samedi de 7 h à 12 h.',[['📍 Google Maps','https://www.google.com/maps/search/?api=1&query=Place+du+Taurobole+26600+Tain-l%27Hermitage'],['ℹ️ Marché — Ville de Tain','https://www.ville-tain.fr/fr/mon-quotidien/marche-et-commerces/marche-hebdomadaire/']]],
['2. Chapelle Saint-Christophe','Monter sur le coteau de l’Hermitage jusqu’à la chapelle Saint-Christophe. Le site domine Tain, le Rhône et les vignobles et constitue un très beau point de vue avant de poursuivre la boucle.',[['📍 Google Maps','https://www.google.com/maps/search/?api=1&query=Chapelle+Saint-Christophe+Tain-l%27Hermitage'],['ℹ️ Patrimoine — Ville de Tain','https://www.ville-tain.fr/fr/ma-ville/histoire/patrimoine/']]],
['3. Domaine du Colombier — Florent et David Viale','Visite chez la famille Viale, recommandée par Simon. Le domaine se trouve au 2 route de Chantemerle à Tain-l’Hermitage. La visite se fait sur rendez-vous; l’heure sera ajustée lorsque le contact avec le domaine sera confirmé.',[['📍 Google Maps','https://www.google.com/maps/search/?api=1&query=Domaine+du+Colombier+2+Route+de+Chantemerle+26600+Tain-l%27Hermitage'],['🍷 Fiche du domaine','https://www.crozes-hermitage-vin.fr/fr/caves-maisons/domaine-du-colombier']]],
...
{n:21,date:'Lundi 21 septembre 2026',title:'Montélimar → Orange',spirit:'Poursuivre vers le sud avec une étape plus courte et une vraie pause pâtisserie en route avant l’arrivée à Orange.',facts:[['Distance','62,6 km'],['Dénivelé positif','271 m'],['Pause pâtisserie','Pierrelatte — vers le km 25'],['Arrivée','Orange']],stops:[
['Départ — Montélimar','Quitter Montélimar et reprendre l’itinéraire vers le sud en suivant le GPX du Jour 21.'],
['🥐 Pierrelatte — vers le km 25','Après environ 1 h 30 à 2 h de vélo, faire la pause pâtisserie-boulangerie à Pierrelatte. C’est le bon moment pour manger, remplir les bouteilles et prendre au besoin une collation pour la suite.',[['🥐 Pâtisseries et boulangeries — Pierrelatte','https://www.google.com/maps/search/?api=1&query=patisserie+boulangerie+Pierrelatte'],['📍 Centre de Pierrelatte','https://www.google.com/maps/search/?api=1&query=centre+Pierrelatte']]],
...
{n:22,date:'Mardi 22 septembre 2026',title:'Orange → Avignon',spirit:'Une courte étape volontairement consacrée à Châteauneuf-du-Pape, avec le retour au Domaine Roger Sabon comme moment fort avant de rejoindre Avignon.',facts:[['Distance','36,6 km'],['Dénivelé positif','236 m'],['Visite principale','Domaine Roger Sabon — Châteauneuf-du-Pape'],['Arrivée','Avignon']],stops:[
['Départ — Orange, vers 8 h 30','Quitter Orange tranquillement. La faible distance de l’étape permet de prendre le temps dans le vignoble sans transformer la journée en course contre la montre.'],
['Châteauneuf-du-Pape — vers 9 h 15','Le GPX fait volontairement le détour par Châteauneuf-du-Pape. Faire ici la pause pâtisserie-boulangerie avant la dégustation, puis poursuivre vers le Domaine Roger Sabon.',[['🥐 Pâtisseries et boulangeries — Châteauneuf-du-Pape','https://www.google.com/maps/search/?api=1&query=patisserie+boulangerie+Chateauneuf-du-Pape'],['📍 Châteauneuf-du-Pape','https://www.google.com/maps/search/?api=1&query=Chateauneuf-du-Pape']]],
['Domaine Roger Sabon — vers 10 h','Point fort de la journée. Retour dans ce domaine déjà visité en 2000 et particulièrement apprécié pour ses vins. Prévoir environ 1 h à 1 h 30 afin de pouvoir déguster sans se presser. Le caveau est situé au 4 bis, avenue Impériale à Châteauneuf-du-Pape.',[['🍷 Domaine Roger Sabon','https://www.domainerogersabon.com/'],['📍 Google Maps','https://www.google.com/maps/search/?api=1&query=Domaine+Roger+Sabon+4+bis+Avenue+Imperiale+Chateauneuf-du-Pape']]],
['Reprise vers Avignon — vers 11 h 30','Après la visite, reprendre le GPX en direction d’Avignon. Il reste environ 24 km; la deuxième moitié de l’étape peut donc se faire à un rythme très tranquille.'],
['Arrivée — Avignon, vers 13 h 30 à 14 h','S’installer à l’hébergement et sécuriser les vélos. Comme deux nuits sont prévues à Avignon, garder les grandes visites pour la journée complète du lendemain et profiter simplement de l’intra-muros en fin de journée.']
],links:[
['GPX - Orange @ Avignon','https://ridewithgps.com/routes/56885622'],
['🍷 Domaine Roger Sabon','https://www.domainerogersabon.com/'],
['🍽️ Restaurants — Avignon','https://www.google.com/maps/search/?api=1&query=restaurants+Avignon'],
['🛒 Épiceries — Avignon','https://www.google.com/maps/search/?api=1&query=epicerie+supermarche+Avignon']
],actions:[['Partager le GPX du Jour 22','share','jour-22-orange-avignon.gpx']]},
  ...
  try{
    ...
    if(navigator.canShare&&navigator.canShare({files:[file]})){
      await navigator.share({
        files:[file],
        title:fileName.includes('jour-22')?'22 septembre — Orange → Avignon':fileName.includes('jour-21')?'21 septembre — Montélimar → Orange':fileName.includes('jour-20')?'20 septembre — Tain-l’Hermitage → Montélimar':fileName.includes('jour-17')?'17 septembre — Belleville-en-Beaujolais → Givors':fileName.includes('jour-16')?'16 septembre — Tournus → Belleville-en-Beaujolais':fileName.includes('jour-15')?'15 septembre — Chagny → Tournus':fileName.includes('jour-14')?'14 septembre — Marsannay-la-Côte → Chagny':fileName.includes('jour-13')?'13 septembre — Boucle dans les vignobles':fileName.includes('jour-11')?'11 septembre — Dole → Marsannay-la-Côte':fileName.includes('jour-10')?'10 septembre — Besançon → Dole':fileName.includes('jour-09')?'9 septembre — L’Isle-sur-le-Doubs → Besançon':fileName.includes('jour-08')?'8 septembre — Aspach-le-Bas → L’Isle-sur-le-Doubs':fileName.includes('jour-07')?'7 septembre — Colmar → Aspach-le-Bas':fileName.includes('jour-06')?'6 septembre — Obernai → Colmar':fileName.includes('jour-05')?'5 septembre — Strasbourg → Obernai':'Parcours Gare de Strasbourg → Airbnb',
