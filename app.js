...
{n:12,date:'Samedi 12 septembre 2026',title:'Journée de congé à Dijon',spirit:'Prendre le temps de découvrir Dijon à pied, en gardant la liberté de choisir les activités selon votre énergie et la météo.',facts:[['Type','Journée de visite'],['Déplacement','À pied'],['Rythme','Libre et sans horaire rigide'],['Hébergement','Deuxième nuit à Dijon']],stops:[
...
...Array.from({length:15},(_,i)=>({n:i+13,date:`${i+13} septembre 2026`,title:i===14?'Arrivée à Sète':'Étape vélo à préciser',spirit:i===14?'Atteindre la Méditerranée et savourer le chemin parcouru.':'Cette étape sera complétée lorsque le découpage définitif sera confirmé.',pending:i!==14,facts:[['Statut',i===14?'Arrivée prévue':'À compléter'],['Parcours','Voir RideWithGPS']],stops:[['Préparation','Cette journée sera détaillée lorsque le découpage définitif des étapes sera confirmé.']]}))
];
