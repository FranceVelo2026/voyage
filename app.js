...
document.addEventListener('click',e=>{
  const rw=e.target.closest('a[data-rwgps="true"]');
  if(rw){ e.preventDefault(); window.open(rw.href,'_blank'); return; }
