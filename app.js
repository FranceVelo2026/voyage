...
...Array.from({length:11},(_,i)=>({n:i+17,date:`${i+17} septembre 2026`,title:i===10?'Arrivée à Sète':'Étape vélo à préciser',spirit:i===10?'Atteindre la Méditerranée et savourer le chemin parcouru.':'Cette étape sera complétée lorsque le découpage définitif sera confirmé.',pending:i!==10,facts:[['Statut',i===10?'Arrivée prévue':'À compléter'],['Parcours','Voir RideWithGPS']],stops:[['Préparation','Cette journée sera détaillée lorsque le découpage définitif des étapes sera confirmé.']]}))
];
