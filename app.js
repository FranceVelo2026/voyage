...
...Array.from({length:8},(_,i)=>({n:i+20,date:`${i+20} septembre 2026`,title:i===7?'Arrivée à Sète':'Étape vélo à préciser',spirit:i===7?'Atteindre la Méditerranée et savourer le chemin parcouru.':'Cette étape sera complétée lorsque le découpage définitif sera confirmé.',pending:i!==7,facts:[['Statut',i===7?'Arrivée prévue':'À compléter'],['Parcours','Voir RideWithGPS']],stops:[['Préparation','Cette journée sera détaillée lorsque le découpage définitif des étapes sera confirmé.']]}))
];
