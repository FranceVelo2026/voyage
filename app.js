...
{n:13,date:'Dimanche 13 septembre 2026',title:'Dijon → Chagny',spirit:'Reprendre la route sans se presser et profiter pleinement des villages viticoles de la Route des Grands Crus.',facts:[['Distance','58,0 km'],['Dénivelé positif','Environ 512 m — à confirmer dans RideWithGPS'],['Arrêt principal','Beaune'],['Hébergement','Airbnb à réserver — Chagny']],stops:[
['Départ — Dijon','Quitter Dijon en direction du sud et rejoindre progressivement les vignobles de la Côte de Nuits.'],
['Gevrey-Chambertin — vers le km 12','Premier arrêt recommandé dans un village emblématique de la Côte de Nuits. La Halle Chambertin présente le vignoble, les climats et le patrimoine local.<br><strong>Pourquoi s’arrêter :</strong> c’est une bonne première immersion dans la Route des Grands Crus et un secteur logique pour une pause boulangerie ou pâtisserie.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Gevrey-Chambertin+centre'],['🥐 Boulangeries et pâtisseries','https://www.google.com/maps/search/?api=1&query=boulangerie+patisserie+Gevrey-Chambertin']]],
['Château du Clos de Vougeot — vers le km 18','Le parcours passe tout près de ce monument emblématique au milieu des vignes.<br><strong>Pourquoi s’arrêter :</strong> même sans visite intérieure, le château et son environnement justifient une courte pause photo de 15 à 30 minutes.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Chateau+du+Clos+de+Vougeot']]],
['Nuits-Saint-Georges — vers le km 23','Principale ville de services avant Beaune, avec commerces, boulangeries, pharmacie et possibilités de ravitaillement.<br><strong>Pourquoi s’arrêter :</strong> c’est une halte de secours pratique si vous avez besoin de provisions ou préférez repousser la pause du matin.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Nuits-Saint-Georges+centre'],['🥐 Boulangeries','https://www.google.com/maps/search/?api=1&query=boulangerie+Nuits-Saint-Georges']]],
['Beaune — vers le km 41','Arrêt principal de la journée. Le centre historique et les Hospices de Beaune offrent une belle occasion de marcher un peu et de dîner.<br><strong>Pourquoi s’arrêter :</strong> Beaune constitue le point fort culturel de l’étape. Prévoir environ une heure, ou davantage si vous décidez demain de raccourcir la journée.',[['📍 Hospices de Beaune','https://www.google.com/maps/search/?api=1&query=Hospices+de+Beaune'],['🥐 Boulangeries et pâtisseries','https://www.google.com/maps/search/?api=1&query=boulangerie+patisserie+centre+Beaune'],['🥡 Repas à emporter','https://www.google.com/maps/search/?api=1&query=restaurant+a+emporter+Beaune']]],
['Meursault — vers le km 49','Village viticole réputé, avec une place centrale agréable et une ambiance plus calme que Beaune.<br><strong>Pourquoi s’arrêter :</strong> dernière pause pittoresque avant les kilomètres finaux vers Chagny; elle reste facultative selon le temps passé à Beaune.',[['📍 Ouvrir dans Google Maps','https://www.google.com/maps/search/?api=1&query=Place+de+l%27Hotel+de+Ville+Meursault']]],
['Arrivée — Chagny','Terminer l’étape à Chagny et rejoindre l’hébergement. La ville offre les services essentiels pour le souper et les provisions du lendemain.'],
['🏡 Hébergement','L’Airbnb n’est pas encore réservé. Privilégier un logement près du centre ou du parcours, avec un endroit sécuritaire pour les deux vélos.'],
['💡 Conseil d’Alice','Le parcours est conservé jusqu’à Chagny pour l’instant. Après discussion avec Manon, l’étape pourra être raccourcie afin de consacrer davantage de temps aux visites, surtout à Beaune.']
],links:[
['🚴 Ouvrir le parcours du Jour 13 dans RideWithGPS','https://ridewithgps.com/routes/56233575'],
['🏡 Demander à Alice de trouver un Airbnb','https://chatgpt.com/'],
['🥡 Repas à emporter — Chagny','https://www.google.com/maps/search/?api=1&query=restaurant+a+emporter+Chagny'],
['🛒 Épiceries et marchés — Chagny','https://www.google.com/maps/search/?api=1&query=epicerie+marche+Chagny']
]},
  ...
  try{
    ...
    if(navigator.canShare&&navigator.canShare({files:[file]})){
      await navigator.share({
        files:[file],
        title:fileName.includes('jour-13')?'Jour 13 — Dijon → Chagny':fileName.includes('jour-11')?'Jour 11 — Dole → Dijon':fileName.includes('jour-10')?'Jour 10 — Besançon → Dole':fileName.includes('jour-09')?'Jour 9 — L’Isle-sur-le-Doubs → Besançon':fileName.includes('jour-08')?'Jour 8 — Aspach-le-Bas → L’Isle-sur-le-Doubs':fileName.includes('jour-07')?'Jour 7 — Colmar → Aspach-le-Bas':fileName.includes('jour-06')?'Jour 6 — Obernai → Colmar via Maison Hauller':fileName.includes('jour-05')?'Jour 5 — Strasbourg → Obernai':'Parcours Gare de Strasbourg → Airbnb',
