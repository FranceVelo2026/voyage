const CACHE="france2026-v1-2";
const ASSETS=["./","index.html","styles.css","app.js","manifest.webmanifest","icon-192.png","icon-512.png","cyclistes-hero.jpg","gare-strasbourg-airbnb.gpx"];
