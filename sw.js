const CACHE="france2026-v2-7-3";
const ASSETS=["./","index.html","styles.css","app.js?v=2.7.3","manifest.webmanifest","icon-192.png","icon-512.png","cyclistes-hero.jpg","jour-07-colmar-aspach-le-bas.gpx","jour-08-aspach-le-bas-lisle-sur-le-doubs.gpx","jour-09-lisle-sur-le-doubs-besancon.gpx","aeronavette-reservation.pdf"];
